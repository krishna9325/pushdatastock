...
public class IntraDayActivity extends AppCompatActivity {
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(IntraDayActivity.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
                    uploadFile();
                }
            }
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(IntraDayActivity.this, "Upload successful", Toast.LENGTH_LONG).show();
                            Task<Uri> uri = taskSnapshot.getStorage().getDownloadUrl();
                            while(!uri.isComplete());
                            Uri url = uri.getResult();
//                            String id = db.collection("uploads").document().getId();

                            IntraDay intraDay = new IntraDay(mEditTextFileName.getText().toString().trim(), url.toString(),
                                    Integer.parseInt(mEditTextUid.getText().toString()), mEditTextDesc.getText().toString().trim(),
                                    mEditTextDate.getText().toString().trim());

                            db.collection("uploads").document(mEditTextUid.getText().toString()).set(intraDay);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(IntraDayActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void openImagesActivity() {
        Intent intent = new Intent(this, IntraDayDisplayActivity.class);
